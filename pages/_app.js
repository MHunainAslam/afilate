...
export default function App({ Component, pageProps }) {
    ...
    if (err) return <div
        ...
        return <div className={`_element ${data.Style === 1 ? '' : data.Style === 2 ? 'wide' : data.Style === 3 ? 'wide' : ''}`}>
            <style jsx global>
                {
                    `:root{
...
:''
                ...
                {
                    data.Style === 1 ?
                        <Footer1 data={data} category={category} season={season} coupons={coupons} country={country} /> : data.Style === 2 ?
                        <Footer2 data={data} category={category} season={season} coupons={coupons} country={country} /> : data.Style === 3 ?
                        <Footer3 data={data} category={category} season={season} coupons={coupons} country={country} /> : ""
