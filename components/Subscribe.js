                        ...
                        <div className="col-7">
                            ...
                            <form class="px-0 my-3 subscribe-form input-group " id='maill' onSubmit={handleContact}>
                                <div class="input-group mb-3 h-100 w-100">
                                    <input class="form-control col-9 border-0" id="email_" type="email" name="email"
                                        placeholder="Email Address" />
                                    <button
                                        class="btn button-secondary  bg-secondary text-uppercase text-white col-3 fw-bolder z-0"
                                        type="submit"
                                        name="newsletter">{isLoading ? 'Subscribing...' : 'Suscribe'}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                </div>
                : data.Style === 3 ? <div className="container">
                    <div class=" my-5">
                        <div className="col-12 text-center">
                            <h1 class="theme3-heading ">Search From Our Partner.</h1>
                            <div className='d-flex mx-auto position-relative ps-3 col flex-column theme3-search sfop'>
                                <Searchbar></Searchbar>
                            </div>
                        </div>
                    </div>
