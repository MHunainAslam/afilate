...
const expire = ({ data, expire, img }) => {
    ...
    return (
        <>
            ...
            <div className="my-2 h-100 px-3 py-2 coupon d-flex bg-white  theme3-top-picks ">
            ...
            <div className="col-8 my-auto px-2 px-md-4">
                ...
                <p className='tr-2 my-1 d-md-block d-none fs-px theme3-heading-m-sub-ex ' dangerouslySetInnerHTML={{ __html: expire.description }}></p>
